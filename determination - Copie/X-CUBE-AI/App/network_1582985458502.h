...
#ifndef __AI_NETWORK_1582985458502_H__
#define __AI_NETWORK_1582985458502_H__
#pragma once

#include "ai_platform.h"

#define AI_NETWORK_1582985458502_MODEL_NAME          "network_1582985458502"

#define AI_NETWORK_1582985458502_IN_NUM       (1)
#define AI_NETWORK_1582985458502_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 100, 1, NULL), \
}
#define AI_NETWORK_1582985458502_IN_SIZE { \
  (1 * 1 * 100), \
}
#define AI_NETWORK_1582985458502_IN_1_SIZE  (1 * 1 * 100)
#define AI_NETWORK_1582985458502_IN_1_SIZE_BYTES  ((1 * 1 * 100) * 4)




#define AI_NETWORK_1582985458502_OUT_NUM      (1)
#define AI_NETWORK_1582985458502_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 3, 1, NULL), \
}
#define AI_NETWORK_1582985458502_OUT_SIZE { \
  (1 * 1 * 3), \
}
#define AI_NETWORK_1582985458502_OUT_1_SIZE  (1 * 1 * 3)
#define AI_NETWORK_1582985458502_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1582985458502
 ...
 * @ref ai_network_1582985458502_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1582985458502_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_1582985458502_*
 * defines into file @ref network_1582985458502.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1582985458502_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_NETWORK_1582985458502_H__*/
