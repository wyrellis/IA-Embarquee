/**
  ******************************************************************************
  * @file    network_1582985458502.c
  * @author  AST Embedded Analytics Research Platform
  * @date    Sat Feb 29 16:02:22 2020
...
#define AI_NET_OBJ_INSTANCE g_network_1582985458502
 
#undef AI_NETWORK_1582985458502_MODEL_SIGNATURE
#define AI_NETWORK_1582985458502_MODEL_SIGNATURE     "c7058b7941143342fcdf9b167404d31a"
...
#define AI_TOOLS_DATE_TIME   "Sat Feb 29 16:02:22 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_NETWORK_1582985458502_N_BATCHES
#define AI_NETWORK_1582985458502_N_BATCHES         (1)
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 24,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    dense_0_weights_array, AI_ARRAY_FORMAT_LUT4_FLOAT,
    NULL, NULL, 2400,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 24, 3, 1, 1), AI_STRIDE_INIT(4, 4, 96, 288, 288),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 24, 24, 1, 1), AI_STRIDE_INIT(4, 1, 12, 288, 288),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 100, 24, 1, 1), AI_STRIDE_INIT(4, 1, 50, 1200, 1200),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 192, 1,
                     NULL),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NETWORK_1582985458502_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NETWORK_1582985458502_OUT_NUM, &nl_3_output),
  &dense_0_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool network_1582985458502_configure_activations(
...
AI_DECLARE_STATIC
ai_bool network_1582985458502_configure_weights(
...
AI_API_ENTRY
ai_bool ai_network_1582985458502_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_NETWORK_1582985458502_MODEL_NAME,
      .model_signature   = AI_NETWORK_1582985458502_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_network_1582985458502_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_network_1582985458502_create(
...
AI_API_ENTRY
ai_handle ai_network_1582985458502_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_network_1582985458502_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= network_1582985458502_configure_weights(net_ctx, &params->params);
  ok &= network_1582985458502_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_network_1582985458502_run(
...
AI_API_ENTRY
ai_i32 ai_network_1582985458502_forward(ai_handle network, const ai_buffer* input)
{
